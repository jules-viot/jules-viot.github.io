...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Jules VIOT')
.pauseFor(300)
.typeString(', <strong> Développeur <span style="color: #ff261b;"> Java</span> !</strong> ')
.pauseFor(1000)
.deleteChars(7)
.typeString('<span style="color: #27ae60;">Python</span> !')
.pauseFor(1000)
.deleteChars(9)
.typeString('<span style="color: #ff6910;">web(HTML, CSS, ReactJS...)</span> !')
.start()
...
const vague3 = document.querySelectorAll('.vague3')
...
const item2Portfolio = document.querySelectorAll('.vague2')

const tlportfolio2 = new TimelineMax();

tlportfolio2
.staggerFrom(item2Portfolio, 1, {opacity:0}, 0.2, '-=0.5')
...
const item3Portfolio = document.querySelectorAll('.vague3')

const tlportfolio3 = new TimelineMax();

tlportfolio3
.staggerFrom(item3Portfolio, 1, {opacity:0}, 0.2, '-=0.5')

const scene4 = new ScrollMagic.Scene({
    triggerElement: item2Portfolio,
    triggerHook: 0.2,
    reverse: false
})
